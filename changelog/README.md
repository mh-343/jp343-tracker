...
| `platforms` | list | any of: `youtube`, `netflix`, `crunchyroll`, `primevideo`, `disneyplus`, `ci-japanese`, `spotify`, `twitch`, `nihongojikan`, `asbplayer`, `mpchc`, `mokuro`, `ttu`. Empty `[]` if change is platform-agnostic |
