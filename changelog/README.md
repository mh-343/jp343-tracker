...
| `platforms` | list | any of: `youtube`, `netflix`, `crunchyroll`, `primevideo`, `disneyplus`, `ci-japanese`, `spotify`, `twitch`, `nihongojikan`, `asbplayer`, `mokuro`, `ttu`. Empty `[]` if change is platform-agnostic |
